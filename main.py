...
getJsonClass = json_to_file.getJson()
serial = getJsonClass.getSN(alert)
getXmlData = user_input.dataFromXml()
tple = getXmlData.searchForID(serial)
getJsonClass.JsonToFile(serial,alert,tple[0],tple[1],tple[2])
